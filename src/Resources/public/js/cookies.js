...
let cookiesBaseContainer = document.getElementById('cookies-base-container');
if (null !== cookiesBaseContainer) {
    fetch(Routing.generate('cookies_render_container'), {
        method: 'post',
        ...
        if (resp.html) {
            cookiesBaseContainer.innerHTML = resp.html;
        }
